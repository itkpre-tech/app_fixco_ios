...
class _CachedImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Image(
      ...
      errorBuilder: (context, error, stackTrace) => fallback, // Fixed multiple underscores
    );
  }
}
        ...
        child: Stack(
          ...
          children: [
            ...
            _CachedImage(
              ...
              fit: BoxFit.cover, // explicitly provided
              fallback: Container(
                color: _surfaceHigh,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.image_rounded, color: _textLight, size: 40),
                    const SizedBox(height: 8),
                    Text(project.title,
